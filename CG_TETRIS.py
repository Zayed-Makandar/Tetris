...
def main_menu(win):
    ...
    while run:
        ...
        for i, stream in enumerate(shape_stream):
            draw_stream(stream, (i - 1) * 3 * block_size, offset[i], int(offset[i] / 40))
        pygame.draw.rect(win, (0, 150, 100), (top_left_x - 125, 50, 550, 550))
        t = 'GOVERNMENT ENGINEERING COLLEGE GANGAVTHI'
        draw_text_name(win, -110, 0, t, 41, (255, 255, 255))
        t = 'COMPUTER GRAPHICS PROJECT'
        draw_text_name(win, -10, 30, t, 39, (255, 255, 255))
        t = 'Made by :'
        draw_text_name(win, -85, 200, t, 36, (255, 255, 255))
        t = 'INDRESH                                    -3NG21CS016'
        draw_text_name(win, -55, 220, t, 39, (255, 255, 255))
        t = 'SYED MAHEBOOB                       -3NG21CS034'
        draw_text_name(win, -55, 240, t, 39, (255, 255, 255))
        t = 'ZAYED MAKANDAR                     -3NG21CS039'
        draw_text_name(win, -55, 260, t, 39, (255, 255, 255))
        t = 'DAVAN KS                                  -3NG22CS404'
        draw_text_name(win, -55, 280, t, 39, (255, 255, 255))
        t = 'Guided by :'
        draw_text_name(win, -85, 310, t, 36, (255, 255, 255))
        t = 'Mrs. RINI HARSHITA                   PROF.CSE.DEPT'
        draw_text_name(win, -55, 330, t, 39, (255, 255, 255))
        t = 'Dr.   GNANESHWARI                    HOD.CSE.DEPT'
        draw_text_name(win, -55, 350, t, 39, (255, 255, 255))
        logo = pygame.image.load('GECG.png')
